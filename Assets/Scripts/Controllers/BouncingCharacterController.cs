...
public class BouncingCharacterController : PossessableCharacterController, IBouncingPhysicsObjectSubscriber, IBouncingFormControllerSubscriber
{
    ...
    public override bool Possess(PossessionPower possessingScript, ReadOnlyArray<InputDevice> inputDevices)
    {
    ...
    public void NotifyPossessed(BouncingFormCharacterController possessedScript, PossessionPower possessingScript, PlayerCharacter possessingController)
    {
        // TODO: Fix this
